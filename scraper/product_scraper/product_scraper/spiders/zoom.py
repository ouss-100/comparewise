...
class ZoomSpider(scrapy.Spider):
    ...
    def parse_product(self, response):
        ...
        item['website_logo'] = "https://zoom.com.tn/img/logo-1706023754.jpg"
        item['categories'] = response.css('ol.breadcrumb li.breadcrumb-item a span::text').getall()
        item['name'] = response.css('div.main-product-details.shadow-box.md-bottom.js-product-container h1.page-heading::text').get(default='')
        item['sku'] = response.css('div.center-wrapper div.attribute-item.product-reference span::text').get(default='')
        item['brand'] = response.css('div.center-wrapper div.attribute-item.product-manufacturer span::text').get(default='')
        item['current_price'] = response.css('div.main-product-details.shadow-box.md-bottom.js-product-container p.current-price span::text').get(default= "0")
        item['regular_price'] = response.css('div.main-product-details.shadow-box.md-bottom.js-product-container p.previous-price span.regular-price::text').get(default= "0")
        item['availability'] = response.css('div.main-product-details.shadow-box.md-bottom.js-product-container span.product-availability::text').get()
        item['description'] = ' '.join(response.css('div.main-product-details.shadow-box.md-bottom.js-product-container div.product-description-short ::text').getall())
